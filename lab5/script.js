class Person {
  ...
  setHealthRate(value) {
    if (value >= 0 && value <= 100) this.#healthRate = value;
    else console.log("value must be between 0 and 100");
  }
  buy = function (items) {
...
class Employee extends Person {
  ...
  setSalary(value) {
    ...
    else console.log("value must be 1000 or more");
  }
  work = function (hours) {
    if (hours == 8) {
      this.workMood = "Happy";
...
const emp_arr = [emp1, emp2];
const office1 = new Office("Office1", emp_arr);
var stop = false;
while (!stop) {
  var x = prompt(
  ...
  if (x == "1") {
    ...
    let d = prompt("what is your sleep mood? happy or tired or lazy");
    let z = prompt("enter your healthRate :100 or 75 or 50");
    let e = prompt("enter your ID");
    let f = prompt("enter your Email");
    let g = prompt("what is your work mood? happy or tired or lazy");
    let h = prompt("enter your salary");
    let i = prompt('if you are manger enter "yes" if not enter " NO"');
